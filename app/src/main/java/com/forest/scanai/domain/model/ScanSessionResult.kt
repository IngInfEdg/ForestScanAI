...
data class ScanSessionResult(
    ...
    val volumeRouteARefinedRaw: Double = 0.0,
    val volumeRouteARefinedCorrected: Double = 0.0,
    val volumeRouteARefinedStereo: Double = 0.0,
    val volumeRouteARefinedNet: Double = 0.0,
    val volumeRouteBDetectedRaw: Double = 0.0,
    val volumeRouteBDetectedCorrected: Double = 0.0,
    val volumeRouteBDetectedStereo: Double = 0.0,
    val volumeRouteBDetectedNet: Double = 0.0,
    val routeAInputCount: Int = 0,
    val routeBInputCount: Int = 0,
    val routeASource: String = "refinedPilePoints",
    val routeBSource: String = "detectionPilePoints",
